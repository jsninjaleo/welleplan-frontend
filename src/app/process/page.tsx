      ...
      >
        ...
        >
          <div className='w-full items-start'>
            ...
            <div className='group-hover/item:transition-all group-hover/item:duration-500 duration-500 ease-in-out h-0 group-hover/item:h-64 flex items-center justify-center bg-mainGrey px-8 py-0 group-hover/item:py-8'>
              <div>
                <Image src="/images/image_consultation.svg" className='group-hover/item:transition-all delay-100 duration-100 ease-in-out opacity-0 group-hover/item:opacity-100 max-w-max !w-48 h-48 pr-8' width={190} height={190} alt="" />
              </div>
              <div className='2xl:text-xl text-sm font-semibold opacity-0 group-hover/item:opacity-100 group-hover/item:transition-all delay-100 duration-100 ease-in-out'>
        ...
        >
          <div className='w-full'>
            ...
            <div className='group-hover/item:transition-all group-hover/item:duration-500 duration-500 ease-in-out h-0 group-hover/item:h-64 flex items-center justify-center bg-mainGrey px-8 py-0 group-hover/item:py-8'>
              <div>
                <Image src="/images/image_planning.svg" className='group-hover/item:transition-all delay-100 duration-100 ease-in-out opacity-0 group-hover/item:opacity-100 max-w-max !w-48 h-48 pr-8' width={190} height={190} alt="" />
              </div>
              <div className='2xl:text-xl text-sm font-semibold opacity-0 group-hover/item:opacity-100 group-hover/item:transition-all delay-100 duration-100 ease-in-out'>
        ...
        >
          <div className='w-full'>
            ...
            <div className='group-hover/item:transition-all group-hover/item:duration-500 duration-500 ease-in-out h-0 group-hover/item:h-64 flex items-center justify-center bg-mainGrey px-8 py-0 group-hover/item:py-8'>
              <div>
                <Image src="/images/image_design.svg" className='group-hover/item:transition-all delay-100 duration-100 ease-in-out opacity-0 group-hover/item:opacity-100 max-w-max !w-48 h-48 pr-8' width={190} height={190} alt="" />
              </div>
              <div className='2xl:text-xl text-sm font-semibold opacity-0 group-hover/item:opacity-100 group-hover/item:transition-all delay-100 duration-100 ease-in-out'>
        ...
        >
          <div className='w-full'>
            ...
            <div className='group-hover/item:transition-all group-hover/item:duration-500 duration-500 ease-in-out h-0 group-hover/item:h-64 flex items-center justify-center bg-mainGrey px-8 py-0 group-hover/item:py-8'>
              <div>
                <Image src="/images/image_development.svg" className='group-hover/item:transition-all delay-100 duration-100 ease-in-out opacity-0 group-hover/item:opacity-100 max-w-max !w-48 h-48 pr-8' width={190} height={190} alt="" />
              </div>
              <div className='2xl:text-xl text-sm font-semibold opacity-0 group-hover/item:opacity-100 group-hover/item:transition-all delay-100 duration-100 ease-in-out'>
        ...
        >
          <div className='w-full'>
            ...
            <div className='group-hover/item:transition-all group-hover/item:duration-500 duration-500 ease-in-out h-0 group-hover/item:h-64 flex items-center justify-center bg-mainGrey px-8 py-0 group-hover/item:py-8'>
              <div>
                <Image src="/images/image_testing.svg" className='group-hover/item:transition-all delay-100 duration-100 ease-in-out opacity-0 group-hover/item:opacity-100 max-w-max !w-48 h-48 pr-8' width={190} height={190} alt="" />
              </div>
              <div className='2xl:text-xl text-sm font-semibold opacity-0 group-hover/item:opacity-100 group-hover/item:transition-all delay-100 duration-100 ease-in-out'>
                Once we have a good understanding of the requirements, we design the system architecture. 
                This includes defining the system&apos;s components, their interactions, and the interfaces between them.
        ...
        >
          <div className='w-full'>
            ...
            <div className='group-hover/item:transition-all group-hover/item:duration-500 duration-500 ease-in-out h-0 group-hover/item:h-64 flex items-center justify-center bg-mainGrey px-8 py-0 group-hover/item:py-8'>
              <div>
                <Image src="/images/image_launch.svg" className='group-hover/item:transition-all delay-100 duration-100 ease-in-out opacity-0 group-hover/item:opacity-100 max-w-max !w-48 h-48 pr-8' width={190} height={190} alt="" />
              </div>
              <div className='2xl:text-xl text-sm font-semibold opacity-0 group-hover/item:opacity-100 group-hover/item:transition-all delay-100 duration-100 ease-in-out'>
                Once the system architecture is in place, we begin development. 
        ...
        >
          <div className='group/item w-1/2 hover:w-full cursor-pointer'>
            ...
            <div className='group-hover/item:transition-all group-hover/item:duration-500 duration-500 ease-in-out h-0 group-hover/item:h-64 flex items-center justify-center bg-mainGrey px-8 py-0 group-hover/item:py-8'>
              <div>
                <Image src="/images/image_support.svg" className='group-hover/item:transition-all delay-100 duration-100 ease-in-out opacity-0 group-hover/item:opacity-100 max-w-max !w-48 h-48 pr-8' width={190} height={190} alt="" />
              </div>
              <div className='2xl:text-xl text-sm font-semibold opacity-0 group-hover/item:opacity-100 group-hover/item:transition-all delay-100 duration-100 ease-in-out'>
