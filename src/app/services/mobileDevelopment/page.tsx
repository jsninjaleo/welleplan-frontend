...
export default function ContactUs() {
  return (
    <div>
      <div className="bg-gradient-to-r from-60% from-lightYellow_gradient to-mainBlue sm:h-[500px] xs:h-[700px] h-[600px] grid lg:grid-cols-2 grid-cols-1 lg:gap-20 lg:pt-52 pt-40 pb-10 2xl:px-52 lg:px-32 xs:px-10 px-5 relative">
        <div className='flex sm:items-center lg:w-full sm:w-2/3 w-full'>
          <div>
            <div className='flex items-center mb-6'>
              <p className='2xl:text-4xl xs:text-3xl text-2xl font-bold mr-3'>Mobile</p>
              <p className='2xl:text-4xl xs:text-3xl text-2xl'>development</p>
            </div>

            <p className='2xl:text-xl xs:text-lg text-base !leading-relaxed font-medium'>
      ...
      <div 
        className="bg-white grid md:grid-cols-3 xs:grid-cols-2 lg:gap-20 gap-10 sm:py-24 py-14 2xl:px-52 lg:px-32 xs:px-10 px-5 relative"
      >
        ...
        {
          mobileDevelopmentList.map((list, index)=> {
            return (
              <div key={index} className='col-span-1'>
                <Image src={list.img} width={46} height={46} alt="" />
                <p className='2xl:text-xl xs:text-lg text-base font-semibold mt-6 mb-4'>{list.title}</p>
